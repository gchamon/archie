...
alias omp:google="omp --smol google-gemini-cli/gemini-3.1-flash-lite-preview:high --slow google-gemini-cli/gemini-3.1-pro-preview:high --plan google-gemini-cli/gemini-3.1-pro-preview --model google-gemini-cli/gemini-3-flash-preview "
